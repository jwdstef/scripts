...
repo2='smiek2221_scripts'                          #预设的 smiek2221 仓库
repo3='QiYueYiya_scripts'                          #预设的 QiYueYiya 仓库
repo4='curtinlv_JD-Script'                         #预设的 curtinlv 仓库
repo5='Tsukasa007_my_script_master'                #预设的 Tsukasa007 仓库
repo6=''                                           #预设的  仓库
repo7=''                                           #预设的  仓库
repo=$repo1                                        #默认调用 yuannian1112 仓库脚本日志
